...
経緯は `docs/kai/02-architecture/01-system.md` §4 冒頭を参照。

設計の正典: `docs/kai/02-architecture/01-system.md` §3(ADR-3) / §4「発話・字幕同期メカニズム」/
...
経緯は `docs/kai/02-architecture/01-system.md` §4 冒頭の実装確定ノートを参照。
