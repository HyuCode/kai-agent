...
echo "Tailscale 越しに使う場合（Issue #77 C1）:"
echo "  1. ~/.config/kai/koe-bridge.env に KOE_BRIDGE_TOKEN=<ランダム値> を書く"
echo "  2. unit の KOE_BRIDGE_BIND / EnvironmentFile のコメントを外して restart"
echo "Mac 側 aquestalk-server の .env:"
echo "  KOE_LLM_BASE_URL=http://<kai-vm の Tailscale IP>:8930/v1"
echo "  KOE_LLM_API_KEY=<KOE_BRIDGE_TOKEN と同じ値>"
